...
import { getAuthUser, setAuthUser } from "../../helpers/auth_storage";
...
const UserProfile = () => {
  ...
  useEffect(() => {
    const obj: any = getAuthUser();
    if (obj) {
      if (!isEmpty(user)) {
        obj.firstname = user.firstname || obj.firstname;
        setAuthUser(obj);
      }
      setUserName(obj.firstname || obj.username || "Admin");
  ...
  document.title = "Profile | APC Sales Analytics";
  return (
    <React.Fragment>
